...
export function DeleteHelperButton({ helperId, helperName }: { helperId: string; helperName: string }) {
  ...
  return (
    <Card className="flex flex-col gap-2 border-red-200 p-4 dark:border-red-900">
      <p className="text-sm font-semibold text-red-700 dark:text-red-400">
        Permanently delete {helperName}?
      </p>
      <p className="text-sm text-neutral-500">
        This removes their entire attendance history, loans, advances, and salary slips. This
        can&apos;t be undone.
      </p>
